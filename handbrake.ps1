...
$filter = "*.mkv" # What video format to search for. Can't figure out how to do multiple.
 
$arguments = "-e nvenc_h265 --encoder-preset slow -q 22 -E copy --comb-detect=fast --decomb=bob" # HandbrakeCLI arguments. -i and -o are handled elsewhere
